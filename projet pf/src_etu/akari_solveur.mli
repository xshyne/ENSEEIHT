...
(* La fonction qui calcule la positivité d'une variable dans un bdd          *)
(* Paramètres:                                                               *)
(* - un bdd                                                                  *)
(* - une case                                                                *)
(* Résultat:                                                                 *)
(* - un boolean qui dit si la case possede une lampe dans tout les cas       *)
...
(* La fonction qui calcule les voisines visibles verticalement d'une case    *)
(* donnée dans une grille donnée.                                            *)
(* Paramètres:                                                               *)
(* - la taille de la grille carrée.                                          *)
(* - la grille initiale de jeu.                                              *)
(* - la case dont on cherche les voisines visibles.                          *)
(* Résultat:                                                                 *)
(* - une liste de toutes les cases visibles verticalement depuis la case     *)
(* donnée                                                                    *)
